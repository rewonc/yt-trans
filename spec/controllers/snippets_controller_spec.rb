...
describe SnippetsController do
  ...
  let(:valid_attributes) { { "starttime" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved snippet as @snippet" do
        ...
        post :create, {:snippet => { "starttime" => "invalid value" }}, valid_session
        assigns(:snippet).should be_a_new(Snippet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested snippet" do
        ...
        Snippet.any_instance.should_receive(:update).with({ "starttime" => "1.5" })
        put :update, {:id => snippet.to_param, :snippet => { "starttime" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the snippet as @snippet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Snippet.any_instance.stub(:save).and_return(false)
        put :update, {:id => snippet.to_param, :snippet => { "starttime" => "invalid value" }}, valid_session
        assigns(:snippet).should eq(snippet)
      end
